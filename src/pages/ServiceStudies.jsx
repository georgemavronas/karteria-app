      ...
      <section className="services">
        <div className="wrap">
          ...
          <ul className="list">
            ...
            <li>Εκπόνηση, έλεγχο και συντονισμό αρχιτεκτονικών και οικοδομικών μελετών.</li>
            <li>Εκπόνηση και έλεγχο στατικών και γεωτεχνικών μελετών.</li>
            <li>Εκπόνηση και έλεγχο υδραυλικών μελετών και μελετών έργων υποδομής.</li>
            <li>Εκπόνηση και έλεγχο ηλεκτρομηχανολογικών μελετών (Η/Μ εγκαταστάσεων).</li>
            <li>Εκπόνηση μελετών οδοποιίας, κυκλοφοριακών και λοιπών ειδικών τεχνικών μελετών, ανάλογα με το αντικείμενο και τις προδιαγραφές του έργου.</li>
            <li>Εκπόνηση περιβαλλοντικών μελετών, περιβαλλοντικών τεκμηριώσεων και μελετών διαμόρφωσης πρασίνου και περιβάλλοντος χώρου, όπου απαιτούνται από το θεσμικό πλαίσιο του έργου.</li>
