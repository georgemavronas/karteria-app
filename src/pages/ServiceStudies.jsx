    ...
    <div className="page">
      ...
      <section className="services">
        <div className="wrap">
          ...
          <p className="sublead">
            Στο πλαίσιο της ωρίμανσης και χρηματοδοτικής προετοιμασίας έργων, παρέχονται επιπλέον:
          </p>
      ...
      <section className="iso">
        <div className="wrap">
          ...
          <p className="lead">
            ...
            μελετών στην υλοποίηση. Η μελετητική διαδικασία βασίζεται στις αρχές των
