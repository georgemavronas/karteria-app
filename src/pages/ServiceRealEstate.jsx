  ...
  return (
    <div className="page">
      ...
      <section className="services">
        <div className="wrap">
          <h2 className="heading">Ανέγερση &amp; Ανάπτυξη Ακινήτων</h2>
          <p className="lead">
      ...
      <section className="services">
        <div className="wrap">
          <h2 className="heading">Αξιοποίηση &amp; Εκμετάλλευση Ακινήτων</h2>
          <p className="lead">
      ...
      <section className="legal">
        <div className="wrap">
          ...
          <p>
            ...
            με το ισχύον πολεοδομικό και κανονιστικό πλαίσιο, όπως αυτό ορίζεται από:
          </p>
          <ul className="list list-legal">
            <li><strong>Ν. 4067/2012</strong> — Νέος Οικοδομικός Κανονισμός (ΝΟΚ)</li>
            <li><strong>Ν. 4495/2017</strong> — Έλεγχος και προστασία του δομημένου περιβάλλοντος</li>
            <li>Εφαρμοστέες διατάξεις που διέπουν την αδειοδότηση, την κατασκευή και τη λειτουργία ακινήτων</li>
          </ul>
